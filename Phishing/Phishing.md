...
Following the initial detection and confirmation of a successful phishing attempt. The severity should be determined following the criteria specified in the [Incident Response Playbook](https://github.com/dhiggins19/IR-Playbooks/tree/main/IncidentResponseOverview). 
